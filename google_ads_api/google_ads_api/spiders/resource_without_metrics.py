...
class ResourceWithoutMetricsSpider(scrapy.Spider):
    ...
    def parse_resource(self, response):
        ...
        # Create a selector for each element
        selector2 = f"body > section > devsite-book-nav > nav > div.devsite-book-nav-wrapper > div.devsite-mobile-nav-bottom > ul > li > div > ul > li:nth-child(1) > div > ul > li:nth-child(4) > div > ul > li:nth-child({i}) > a > span"
